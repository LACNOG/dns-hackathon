...
+--------------+-----------------------+-----------------------------+
| grpX-cli     | 100.100.X.2 (eth0)    | fd31:3309:X::2 (eth0)       |
+--------------+-----------------------+-----------------------------+
| grpX-ns1     | 100.100.X.130 (eth0)  | fd31:3309:X:128::130 (eth0) |
+--------------+-----------------------+-----------------------------+
| grpX-ns2     | 100.100.X.131 (eth0)  | fd31:3309:X:128::131 (eth0) |
+--------------+-----------------------+-----------------------------+
| grpX-resolv1 | 100.100.X.67 (eth0)   | fd31:3309:X:64::67 (eth0)   |
+--------------+-----------------------+-----------------------------+
| grpX-resolv2 | 100.100.X.68 (eth0)   | fd31:3309:X:64::68 (eth0)   |
+--------------+-----------------------+-----------------------------+
| grpX-rtr     | 100.64.1.X (eth0)     | fd31:3309:X::1 (eth1)       |
|              | 100.100.X.65 (eth2)   | fd31:3309:X:64::1 (eth2)    |
|              | 100.100.X.193 (eth4)  | fd31:3309:X:192::1 (eth4)   |
|              | 100.100.X.129 (eth3)  | fd31:3309:X:128::1 (eth3)   |
|              | 100.100.X.1 (eth1)    | fd31:3309:0:1::X (eth0)     |
+--------------+-----------------------+-----------------------------+
| grpX-soa     | 100.100.X.66 (eth0)   | fd31:3309:X:64::66 (eth0)   |
+--------------+-----------------------+-----------------------------+
```
...
- Rango de direcciones IPv6 del laboratorio: fd31:3309::/32
...
Para probar si el QNAME Minimisation funciona siempre correctamente en modo estricto, pueden probar resolver el nombre ***hostname.lab.lacnic44.vulcano.cl*** con tipo A. Si tienen respuesta, entonces está en modo relajado. Si les devuelve NXDOMAIN, entonces está en modo estricto.
...
$TTL    30
@       IN      SOA     grpX.lacnic44.te-labs.training. root.example.com (                                            
                              1         ; Serial
                         604800         ; Refresh
                          86400         ; Retry
                        2419200         ; Expire
...
; grpX 
@             NS           ns1.grpX.lacnic44.te-labs.training.
@             NS           ns2.grpX.lacnic44.te-labs.training.

ns1         A           100.100.X.130
ns1         AAAA        fd31:3309:X:128::130
ns2         A           100.100.X.131
ns2         AAAA        fd31:3309:X:128::131
...
```
# dig @localhost dnskey grpX.lacnic44.te-labs.training | dnssec-dsfromkey -f - grpX.lacnic44.te-labs.training > /var/dns/dnssec/keys/DS.record
```
...
```
grpX.lacnic44.te-labs.training. IN DS 23471 13 2 018A86C0139BA5500AC87A5BAD8FB5D8D4F9672C319B34DB5A7F3BC10A424D6E
```
